...
def sheet_to_dfs(sheet_name='Projects Team Structure'):
    """
    Create pandas dataframes from sheet information.

    :param sheet_name: sheet name, in this case defaults to 'Projects Team Structure'
...
def add_project_slide(prs, df, row_index, df2):
    ...
    :param df2: pandas dataframe with resources and responsabilities information
    """
    ...
    if len(p_description) > 400:
        description_font = Pt(10)
...
def add_rectangle(
    ...
    :param rol: string with rol
    :param fill_color: rectangle fill color
    :param font_color: rectangle text font color
    :param left: distance (in inches) to left edge of slide (each slide is 10 per 7.5 inches)
...
def daily_presentation(df, output_to):
    """
    Create Daily Report Presentation.

    :param df: pandas dataframe with the information needed for the report
    :param output_to: path to save output pptx file
    """
    prs = Presentation()
...
def make_rectangle(
    ...
    :param shapes: shapes attribute from slide (which in turn is an attribute of the presentation) 
    :param sentence: text inside rectangle
    :param left: distance (in inches) to left edge of slide (each slide is 10 per 7.5 inches)
    :param top: distance (in inches) to top edge of slide
    :param width: rectangle's width
    :param heigth: rectangle's heigth
    :param font_color: font color
    :param fill_color: fill color
