...
def graph(df, df2):
    """
    Generate a directed Graph, with project names, 
    delivery managers and resources and save it to pdf file.

    :param df: pandas dataframe with 'delivery_manager' and 'project_name' columns
    :param df2: pandas dataframe with 'project_name' and 'resource_name' columns
...
def bar_plot(df, df2, colors=color_set):
    """
    Plots a bar plot with the amount of resources per project, and saves it to a png file.

    :param df: pandas dataframe with 'project_name' column
    :param df2: pandas dataframe with 'project_name' and 'resource_name' columns
...
def pie_chart(df, df2, colors=color_set):
    """
    Plots a pie chart with the proportion of resources per project, and saves it to a png file.
...
def convert_to_lists(df_col):
    """
    Given a dataframe's columns, create a list with a list for each element, 
    these lists are generated splitting each element by commas.
